...
/**
 点击我的二维码的回调
 */
@property (nonatomic,copy) WSLMyQRCodeBlock _Nullable myQRCodeBlock;

/**
 打开/关闭闪光灯的回调
 */
@property (nonatomic,copy) WSLFlashSwitchBlock _Nullable  flashSwitchBlock;
/**
 相机回调
 */
@property (nonatomic,copy)void(^ _Nonnull cameraBlock)(void);
#pragma mark - 扫码区域
