...
@interface EaseMessageReadManager() <MWPhotoBrowserDelegate,MWPhoto>
...
- (void)showBrowserWithImages:(NSArray *)imageArray
{
    ...
    [self.photoNavigationController setModalPresentationStyle:UIModalPresentationOverFullScreen];
