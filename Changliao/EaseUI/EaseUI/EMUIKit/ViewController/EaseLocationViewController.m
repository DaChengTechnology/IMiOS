...
//    [backButton setImage:[UIImage imageNamed:@"myselfNewBack"] forState:UIControlStateNormal];
...
//    [self.navigationItem setLeftBarButtonItem:backItem];
    ...
    if (_isSendLocation) {
        ...
        UIButton *sendButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 0, 0)];
        [sendButton setTitle:@"发送" forState:UIControlStateNormal];
        sendButton.accessibilityIdentifier = @"send_location";
        [sendButton setTitleColor:[UIColor colorWithRed:236 / 255.0 green:88 / 255.0 blue:46 / 255.0 alpha:1.0] forState:UIControlStateNormal];
