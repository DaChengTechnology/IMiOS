...
+ (void)initialize
{
    ...
    moreView.moreViewBackgroundColor = kColorFromRGBHex(0xf6f6f6);
}
...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoButton = [self btnWithImage:[UIImage imageNamed:@"照片.视频"]
                     highlightedImage:[UIImage imageNamed:@"照片.视频"]
                                title:@"相册"];
    ...
    _locationButton = [self btnWithImage:[UIImage imageNamed:@"位置"]
                        highlightedImage:[UIImage imageNamed:@"位置"]
                                   title:@"位置"];
    ...
    _takePicButton = [self btnWithImage:[UIImage imageNamed:@"摄像头"]
                       highlightedImage:[UIImage imageNamed:@"摄像头"]
                                  title:@"拍照"];
    ...
    _audioCallButton = [self btnWithImage:[UIImage imageNamed:@"语音聊天"]
                         highlightedImage:[UIImage imageNamed:@"语音聊天"]
                                    title:nil];
    ...
    _videoCallButton = [self btnWithImage:[UIImage imageNamed:@"视频聊天"]
                         highlightedImage:[UIImage imageNamed:@"视频聊天"]
                                    title:nil];
...
- (UIButton *)btnWithImage:(UIImage *)aImage highlightedImage:(UIImage *)aHighLightedImage title:(NSString *)aTitle {
    ...
    btn.imageEdgeInsets = UIEdgeInsetsMake(0, -2, 10, -2);
    btn.titleEdgeInsets = UIEdgeInsetsMake(50, -50, -10, 0);
    return btn;
}
