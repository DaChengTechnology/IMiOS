...
@property (strong, nonatomic) UILabel *userIDCardLab;
@property (strong, nonatomic) UIView * cardLineView;
@property (strong, nonatomic) UILabel * placerHoderLab;
@property (strong, nonatomic) UIImageView * cardBackImg;
