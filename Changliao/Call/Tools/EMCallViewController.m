...
- (void)_setupCallControllerSubviews
{
    ...
    [self.microphoneButton setImage:[UIImage imageNamed:@"麦克风-静音(3)"] forState:UIControlStateNormal];
    [self.microphoneButton setTitleColor:[UIColor grayColor] forState:UIControlStateSelected];
    [self.microphoneButton setImage:[UIImage imageNamed:@"麦克风灰"] forState:UIControlStateSelected];
    ...
    [self.speakerButton setImage:[UIImage imageNamed:@"免提"] forState:UIControlStateNormal];
    [self.speakerButton setTitleColor:[UIColor blackColor] forState:UIControlStateSelected];
    [self.speakerButton setImage:[UIImage imageNamed:@"免提"] forState:UIControlStateSelected];
    ...
    self.hangupButton = [[EMButton alloc] initWithTitle:@"挂断" target:self action:@selector(hangupAction)];
